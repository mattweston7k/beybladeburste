Parts = {
    ...
    titles: {remake: '〔復刻〕攻擊環 結晶輪盤 Remake Layer', LB:'〔超王 限界突破〕刃輪 戰輪 Ring & 金屬 鋼鐵 輪盤 Disk',
        layer7a: '〔DB〕裝甲 戰甲 Armor', layer7b: '〔DB〕刀環 戰刃 Blade', layer7c: '〔DB〕核心 Core', layer7: '〔DB〕攻擊環 結晶輪盤 Layer',
...
const Tools = {
    filter(group) {
        ...
        else if (count('a:not([id^="+"])>object[data*=unk]') === 0 && !/^(disk|frame)/.test(group))
